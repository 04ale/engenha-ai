...
import type { RegisterInput, LoginInput, ResetPasswordRequestInput, ResetPasswordConfirmInput } from "@/lib/validations/auth"
...
export const authService = {
  async register(data: RegisterInput): Promise<{ user: User | null; error: string | null }> {
    try {
  ...
  async login(data: LoginInput): Promise<{ user: User | null; error: string | null }> {
    try {
  ...
  async requestPasswordReset(data: ResetPasswordRequestInput): Promise<{ error: string | null }> {
  ...
  async confirmPasswordReset(data: ResetPasswordConfirmInput): Promise<{ error: string | null }> {
